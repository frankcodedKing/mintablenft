...
import { payToMint } from '../Mintable'
import { connectWallet } from '../Mintable'
...
const Hero = () => {
  ...
  return (
    <div
      className="bg-[url('https://cdn.pixabay.com/photo/2023/01/07/09/20/ai-generated-7702855_960_720.jpg')]
      ...
      <div className="flex flex-col justify-center items-center mx-auto py-10">
        <div className="flex flex-col justify-center items-center">
          ...
          >
            ...
            <div className="flex flex-col font-semibold">
             ...
             <span className="text-white text-sm">
              ...
              <span className="text-white text-sm" onClick={connectWallet}
              >
                Connect Wallet
              </span>
            ...
            {/* BUTTON CONNECT */}
              ...
              <span className="text-[#e32970] text-xs">Mintable User</span>
            </div>
          </a>

          <p className="text-white text-sm font-medium text-center">
            Franklin kick-started his journey as a software engineer in
          ...
          <ul className="flex flex-row justify-center space-x-2 items-center my-4">
            ...
            <a
              className="bg-white hover:scale-50 transition-all duration-75 delay-75 rounded-full mx-2"
              href="https://www.linkedin.com/in/franklin-ugwuoke-945829212/"
            >
